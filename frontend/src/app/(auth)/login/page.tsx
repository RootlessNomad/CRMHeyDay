...
// Página de login.
// - Validación zod (email + min length password)
// - Submit POST /auth/login (cookie refresh la fija el backend automáticamente)
// - Acceso guardado en memoria (useAuthStore)
// - Mensajes de error del backend traducidos a copy en ES
// - Disabled state mientras la request está pendiente
// - Tras OK: redirige a ?next= si existe, o a /dashboard
